        ...
        private void SetConsoleSymbolForCell(Console console, Cell cell)
        {
            ...
            }else if (RogueGame._mapLevel == 1)
            {
                ...
                if (IsInFov(cell.X, cell.Y))
                {
                    if (cell.IsWalkable)
                    {
                        console.CellData.SetCharacter(cell.X, cell.Y, '.', Colors.Sand, Colors.Sand);
                    }
                    else
                    {
                        console.CellData.SetCharacter(cell.X, cell.Y, '#', Colors.Wall, Colors.WallBackgroundFov);
                    }
                }
                else
                {
